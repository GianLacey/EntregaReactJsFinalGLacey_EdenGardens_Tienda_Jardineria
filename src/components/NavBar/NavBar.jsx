    ...
    return (
        <div>
            <header className="bg-gray-50">
                <div className="">
                    <div className="flex items-center p-1 bg-lime-900">
                    ...
                    <div className="flex flex-1 items-center justify-between gap-8 sm:justify-start ">
                        ...
                        <div className="flex flex-1 justify-end me-3 items-center mb-1">
                            <div className="relative">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="rgb(107 114 128)" className="w-6 h-6">
