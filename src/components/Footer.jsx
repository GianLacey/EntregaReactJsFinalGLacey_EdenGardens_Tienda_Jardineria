    ...
    return (
        <footer className="mt-52 text-center font-monserrat">
            <section>
                ...
                <div className="pt-14 px-10 flex text-xxs text-white h-52 bg-gray-700 justify-between leading-5 z-0">
                    <div>
            ...
            <section className="bg-slate-100 py-6 text-xs bg-gray-200">
