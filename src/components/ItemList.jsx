                    ...
                    <div key={product.id} className="mx-auto w-60 my-2 p-1">
                        <div className="space-y-1 mx-auto h-full py-2 bg-gray-800 rounded-xl space-x-10">
                            <div className="w-auto">
                                {/* Utiliza product.thumbnail ya que cada producto tiene su propia thumbnail */}
                                <img className="flex-1 h-full px-2 rounded-t-xl" src={product.thumbnail} alt={product.title} />
                            </div>
                            <div className="w-2/3">
