        ...
        <div>
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-0">
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4 lg:px-6">
                    ...
                    <div className="pt-6" id="filter-section-0">
                      <div className="space-y-4 ">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-color-0" className="ml-3 text-sm text-gray-600">Barro</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-color-1" className="ml-3 text-sm text-gray-600">Cemento</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-color-1" name="color[]" value="beige" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-color-1" className="ml-3 text-sm text-gray-600">Plastico</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-color-1" name="color[]" value="beige" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-color-1" className="ml-3 text-sm text-gray-600">Fibra</label>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="pt-6" id="filter-section-1">
                      <div className="space-y-4 ">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-600">Cuadrada</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-category-2" name="category[]" value="travel" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-category-2" className="ml-3 text-sm text-gray-600">Circular</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-category-3" className="ml-3 text-sm text-gray-600">Rectangular</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-category-3" name="category[]" value="organization" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-category-3" className="ml-3 text-sm text-gray-600">Forma organica</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-category-3" name="category[]" value="organization" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-category-3" className="ml-3 text-sm text-gray-600">Colgante</label>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="pt-6" id="filter-section-2">
                      <div className="space-y-4">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-size-0" className="ml-3 text-sm text-gray-600">5lts</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-size-1" name="size[]" value="6l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-size-1" className="ml-3 text-sm text-gray-600">10lts</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-size-2" name="size[]" value="12l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-size-2" className="ml-3 text-sm text-gray-600">15lts</label>
                        </div>
                        <div className="flex items-center">
                          <input id="filter-size-3" name="size[]" value="18l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-green-primary" />
                          <label htmlFor="filter-size-3" className="ml-3 text-sm text-gray-600">20lts o más</label>
                        </div>
                      </div>
                    </div>
                  </div>
