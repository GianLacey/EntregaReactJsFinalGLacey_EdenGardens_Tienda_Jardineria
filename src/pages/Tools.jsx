...
export const Tools = (props) => {
  ...
  //titulo de mi page  
  useEffect(() => {
    document.title = "Herramientas | Eden Gardens | Tienda Online de artículos para huerta, jardinería y paisajismo "
  })

  return (
    <div>
      <div className="overflow-hidden h-52 w-full flex">
        <img className='w-full opacity-90 object-cover mt-[-700px]' src="../src/assets/img/fondo-tools.jpg" alt="" />
        <img className='w-full opacity-90 object-cover mt-[-90px]' src="../src/assets/img/fondo-machines.jpg" alt="" />
      </div>
                    ...
                    <div className="pt-6" id="filter-section-1">
                      <div className="space-y-4 ">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-600">Medicinales</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-category-2" className="ml-3 text-sm text-gray-600">Aromáticas</label>
                        </div>
                        <div className="flex items-center">
                    ...
                    <div className="pt-6" id="filter-section-2">
                      <div className="space-y-4">
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-size-0" className="ml-3 text-sm text-gray-600">Primavera</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-size-1" className="ml-3 text-sm text-gray-600">Verano</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-size-2" className="ml-3 text-sm text-gray-600">Otoño</label>
                        </div>
                        <div className="flex items-center">
                          ...
                          <label htmlFor="filter-size-3" className="ml-3 text-sm text-gray-600">Invierno</label>
                        </div>
                      </div>
                    </div>
                  </div>
